...
секунд (быстрый старт/перемотка), а дальше читает вход со скоростью ~1x
(`-readrate 1.0 -readrate_initial_burst N`). Плюс фоновый **уборщик** убивает сессии,
...
| `BufferBurstSeconds` | `30`       | начальный «бёрст» перед пейсингом ~1x (быстрый старт ↔ нагрузка CPU); 0 — без пейсинга |
