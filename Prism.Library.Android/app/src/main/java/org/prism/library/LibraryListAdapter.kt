...
// onFileClick — выбор файла: строка файла целиком открывает шторку выбора
// действия («информация» или «включить на плеере», шаг 7, см.
// FileActionsBottomSheet) — сама строка списка действия не разделяет.
class LibraryListAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when (val item = items[position]) {
            ...
            // Файл: клик/центр пульта открывает шторку выбора действия
            // («информация» / «включить на плеере», шаг 7). Доступен и для недоступных файлов
