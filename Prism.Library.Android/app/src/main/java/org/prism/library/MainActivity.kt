...
class MainActivity : FragmentActivity() {
    ...
    //   он сейчас доступен; иначе (present=false, GET /api/media такие файлы
    //   не возвращает) используем заглушку с id вместо названия — адаптер
    //   помечает такую строку как недоступную (см. LibraryListAdapter).
